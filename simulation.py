...
class Simulation(object):
    ...
    def run(self):
        ...
        self.logger.log_summary(total_living, self.total_dead, self.total_vaccinated, self.simulation_end_reason, self.num_interactions, self.vaccine_interactions, self.death_interactions)
...
# SAMPLE TESTS
# RUN THIS TEST: python3 simulation.py 10000 0.90 Ebola 0.70 0.25 10
# SMALLER test: python3 simulation.py 100 0.10 Ebola 0.70 0.25 10
# python3 simulation.py 5000 0.67 Influenza 0.63 0.15 213
# python3 simulation.py 30000 0.40 COVID-19 0.05 0.46 7900
